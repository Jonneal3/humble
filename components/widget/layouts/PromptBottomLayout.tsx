...
export function PromptBottomLayout({
  ...
  return (
    <div className="h-full flex flex-col max-w-6xl mx-auto">
      ...
      {/* Desktop Layout: ChatGPT Style with Fixed Bottom Bar (lg breakpoint and above) */}
      <div className="hidden lg:flex lg:flex-col lg:flex-1 lg:relative">
        {/* Images Area - Takes most space but leaves room for fixed prompt */}
        <div className="flex-1 pb-4" style={{ height: '100%', overflow: 'hidden' }}>
          <ImageGallery
            images={generatedImages}
            isLoading={isLoading}
            config={config}
        ...
        {/* Fixed Prompt Bar - Sticky at bottom but within layout flow */}
        <div className="flex-shrink-0 sticky bottom-0 z-10 bg-gradient-to-t from-white via-white/98 to-white/90 backdrop-blur-sm pt-6">
          <div className="w-full max-w-4xl mx-auto pb-4">
            <div className="rounded-2xl p-4 sm:p-5 border transition-all duration-300 shadow-lg backdrop-blur-sm"
              style={{
