      ...
      <div className="space-y-4 mt-2">
        ...
        >
          ...
          >
            ...
            <ChevronDown className={`h-4 w-4 transition-transform text-muted-foreground ${designSections['overall-style'] ? 'rotate-180' : ''}`} />
          </summary>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    onClick={() => handlePaddingSync(config.container_padding || 24)}
                  >
                    Sync All
                  </Button>
                </div>
                ...
                <NumberInput
                  ...
                  onChange={(value) => handlePaddingSync(value)}
                  min={0}
                  max={120}
                />
        ...
        >
          ...
          >
            ...
            <ChevronDown className={`h-4 w-4 transition-transform text-muted-foreground ${designSections['layout'] ? 'rotate-180' : ''}`} />
          </summary>
        ...
        >
          ...
          >
            ...
            <ChevronDown className={`h-4 w-4 transition-transform text-muted-foreground ${designSections['input-section'] ? 'rotate-180' : ''}`} />
          </summary>
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="space-y-1.5 bg-background/50 rounded-md p-3">
                <Label className="text-xs font-medium">Overall Input Area</Label>
                <ColorInput
            ...
            >
              ...
              >
                ...
                <ChevronDown className={`h-3 w-3 transition-transform text-muted-foreground ${designSections['uploader'] ? 'rotate-180' : ''}`} />
              </summary>
            ...
            >
              ...
              >
                ...
                <ChevronDown className={`h-3 w-3 transition-transform text-muted-foreground ${designSections['prompt'] ? 'rotate-180' : ''}`} />
              </summary>
              <div className="space-y-3 px-3 pb-3">
                {/* Typography Section */}
                <div className="space-y-3">
            ...
            >
              ...
              >
                ...
                <ChevronDown className={`h-3 w-3 transition-transform text-muted-foreground ${designSections['suggestions'] ? 'rotate-180' : ''}`} />
              </summary>
              <div className="space-y-3 px-3 pb-3">
                <div className="flex items-center justify-between">
        ...
        >
          ...
          >
            ...
            <ChevronDown className={`h-4 w-4 transition-transform text-muted-foreground ${designSections['gallery'] ? 'rotate-180' : ''}`} />
          </summary>
          <div className="space-y-4 pl-2">
        ...
        >
          ...
          >
            ...
            <ChevronDown className={`h-4 w-4 transition-transform text-muted-foreground ${designSections.demo_overlay ? 'rotate-180' : ''}`} />
          </summary>
          <div className="border-t">
            <div className="p-3">
              <div className="grid gap-2">
                <div className="flex items-center justify-between">
                  <Label className="text-xs font-medium">Show Demo Overlay</Label>
                  <Switch
